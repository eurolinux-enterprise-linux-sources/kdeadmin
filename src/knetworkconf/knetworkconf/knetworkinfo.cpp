...
void KNetworkInfo::setDeviceList(Q3PtrList<KNetworkInterface> deviceList){
...
Q3PtrList<KNetworkInterface> KNetworkInfo::getDeviceList(){
  return deviceList;
}  
...
void KNetworkInfo::setProfilesList(Q3PtrList<KNetworkInfo> profilesList){
  KNetworkInfo::profilesList = profilesList;
}  

Q3PtrList<KNetworkInfo> KNetworkInfo::getProfilesList(){
  return profilesList;
}
