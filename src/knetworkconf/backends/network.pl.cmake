...
sub gst_network_get_broadcast_ping_cmd
{
  ...
  my %dist_map =
      (
       ...
       "mandriva-2008.0" => "redhat-6.2",
       "mandriva-2008.1" => "redhat-6.2",
       "mandriva-2009.0" => "redhat-6.2",
       "mandriva-2009.1" => "redhat-6.2",
       "mandriva-2010.0" => "redhat-6.2",
...
sub gst_network_get_file
{
  ...
  my %dist_map =
	 (
	  ...
	  "mandriva-2008.0" => \&gst_network_rh62_get_file,
	  "mandriva-2008.1" => \&gst_network_rh62_get_file,
	  "mandriva-2009.0" => \&gst_network_rh62_get_file,
	  "mandriva-2009.1" => \&gst_network_rh62_get_file,
	  "mandriva-2010.0" => \&gst_network_rh62_get_file,
	  ...
	  "fedora"       => \&gst_network_rh72_get_file,
...
sub gst_network_get_parse_table
{
  my %dist_map =
	 (
	  ...
	  "mandriva-2008.0" => "redhat-7.0",
	  "mandriva-2008.1" => "redhat-7.0",
	  "mandriva-2009.0" => "redhat-7.0",
	  "mandriva-2009.1" => "redhat-7.0",
	  "mandriva-2010.0" => "redhat-7.0",
...
sub gst_network_get_interface_parse_table
{
  my %dist_map =
	 (
	  ...
	  "mandriva-2008.0" => "mandrake-9.0",
	  "mandriva-2008.1" => "mandrake-9.0",
	  "mandriva-2009.0" => "mandrake-9.0",
	  "mandriva-2009.1" => "mandrake-9.0",
	  "mandriva-2010.0" => "mandrake-9.0",
